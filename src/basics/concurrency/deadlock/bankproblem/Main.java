...
public class Main {
    public static void main(String[] a) {
        //total sum of Money in all accounts remain the same.
        Bank bank = new Bank();
        ...
        Thread t1 = new Thread(new Worker(account1, account4, bank, 100));
        Thread t2 = new Thread(new Worker(account1, account2, bank, 500));
        Thread t3 = new Thread(new Worker(account3, account4, bank, 50));
        Thread t4 = new Thread(new Worker(account4, account2, bank, 1000));
        Thread t5 = new Thread(new Worker(account5, account1, bank, 200));
        Thread t6 = new Thread(new Worker(account6, account3, bank, 300));
